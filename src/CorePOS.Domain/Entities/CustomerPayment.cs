...
public class CustomerPayment : AuditableEntity
{
    ...
    public static CustomerPayment Create(string paymentNo, int customerId,
        decimal amount, PaymentMethod method, int? cashBoxId = null,
        int? shiftId = null, string? notes = null)
    {
        ...
        return new CustomerPayment
        {
            ...
            CustomerId = customerId, Amount = amount, PaymentMethod = method,
            CashBoxId = cashBoxId, ShiftId = shiftId, Notes = notes
        };
    }
}
